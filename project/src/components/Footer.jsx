  ...
  return (
    <footer className="min-h-96 bg-[#062800] text-white flex flex-col justify-between p-8 pt-10">
        ...
        <div className='w-[35rem]'>
            <h1 className="text-2xl font-oxanium font-bold mb-4">DevJam 1.O</h1>
      ...
      <div className="mb-8 font-oxanium">
        ...
        <h2 className="text-xl mb-4 relative group text-xl hover:transition duration-300">Timeline<span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#5dffa2] transition-all duration-300 group-hover:w-full"></span></h2>
      </div>
